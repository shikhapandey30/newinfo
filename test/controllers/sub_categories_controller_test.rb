...
class SubCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post sub_categories_url, params: { sub_category: { category_id: @sub_category.category_id, image: @sub_category.image, name: @sub_category.name } }
    end
  ...
  test "should update sub_category" do
    patch sub_category_url(@sub_category), params: { sub_category: { category_id: @sub_category.category_id, image: @sub_category.image, name: @sub_category.name } }
